<?php
/**
 * games/tic_tac_toe/tic_tac_toe_backend.php
 * YOPY Tic-Tac-Toe — Backend API
 *
 * ?action=start    — creates game_session, returns session_id
...
function handleStart(PDO $pdo): void
{
    ...
    $gameId = GameService::getIdBySlug($pdo, 'tic_tac_toe');
...
// ────────────────────────────────────────────────────────────────────────────
// ACTION: score
// Score = wins × mult (Easy×10, Medium×15, Hard×20).
// Ties on Hard give ×10 (blocking a perfect bot is an achievement).
// Max theoretical: ~30 wins × 20 = 600. Hard cap at 1000.
// ────────────────────────────────────────────────────────────────────────────
function handleScore(PDO $pdo): void
{
    ...
    unset($_SESSION['behavior']['tic_tac_toe']);
