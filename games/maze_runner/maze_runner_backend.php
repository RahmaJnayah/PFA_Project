<?php
/**
 * games/maze_runner/maze_runner_backend.php
 * YOPY Maze Runner — Backend API
 */
session_start();
...
function handleStart(PDO $pdo): void {
    ...
    $gameId = GameService::getIdBySlug($pdo, 'maze_runner');
...
function handleScore(PDO $pdo): void
{
    ...
    unset($_SESSION['behavior']['maze_runner']);
